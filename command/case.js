	...
	try {
        ...
        const sendStickerFromUrl = async(to, url) => {
            ...
            if(mime.split("/")[0] === "audio"){
		        ...
		        await haruka.sendMessage(from, `iRexus Detecting Link`, text , {quoted: mek})
...
case 'infobot':
if (!isHaruka) return sendButMessage(from, lang.noregis(pushname), `Klik Button Untuk Verify`, [{buttonId: '.daftar',buttonText: {displayText: `Daftar`,},type: 1,}], {quoted: fgif});
			reply('Update bot selanjutnya silahkan join discord kami (https://discord.io/RED-ANGEL')
break
case 'owner':{
	if (!isHaruka) return sendButMessage(from, lang.noregis(pushname), `Klik Button Untuk Verify`, [{buttonId: '.daftar',buttonText: {displayText: `Daftar`,},type: 1,}], {quoted: fgif});
